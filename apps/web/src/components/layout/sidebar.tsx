...
const menuSections: { label: string | null; items: MenuItem[] }[] = [
  ...
  },
  {
    label: '受付',
    items: [
      { href: '/queue', label: '受付番号管理', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
      { href: '/prescriptions', label: '処方せん管理', icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z' },
    ],
  },
  {
    label: '分析',
  ...
  const sidebarContent = (
    <>
      ...
      <div className="px-6 py-4 border-t border-gray-200 space-y-3">
        {typeof window !== 'undefined' && localStorage.getItem('lh_staff') && (
        ...
        <button
          onClick={() => {
            ...
            localStorage.removeItem('lh_staff')
